...
local reloader = function()
  if SHOULD_RELOAD_TELESCOPE then
    ...
    RELOAD "popup"
    RELOAD "telescope"
    RELOAD "xiuxiu.telescope.setup"
    RELOAD "xiuxiu.telescope.custom"
  end
end
...
return setmetatable({}, {
  __index = function(_, k)
    ...
    local has_custom, custom = pcall(require, string.format("xiuxiu.telescope.custom.%s", k))
